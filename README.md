...
1. **Mutfak Modeli** → Mutfak dolapları, tezgâh ve detaylı mutfak sahnesi  
2. **Koltuk Modeli** → Koltuk, minder ve yastık detaylarıyla birlikte  
3. **Çimen ve Kaya Modeli** → Üzerinde kaya bulunan çimen yüzeyi  
...
- `mutfak.png`, `mutfak2.png`, `mutfak3.png`, `mutfak4.png` → Mutfak renderları  
